...
function calcComplexity()
{
	...
	console.log(num.Excess,num.Upper,num.Numbers,num.Symbols,bonus.Combo,bonus.FlatLower,bonus.FlatNumber)
...
function outputResult()
{
	if ($("#userInput").val()== "")
	{ 
		strength.html("Strength Meter").removeClass("weak strong stronger strongest").addClass("default");
	}
	else if (charPassword.length < minPasswordLength)
	{
		strength.html("At least " + minPasswordLength+ " characters please!").removeClass("strong stronger strongest").addClass("default");
	}
	else if (score<50)
	{
	...
	else if (score>=100)
	{
		...
		/*$("#specs").html("Base Score :<span class=\"value\">" + baseScore  + "</span>"
